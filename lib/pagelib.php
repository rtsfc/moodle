    ...
    protected function magic_get_context() {
        if (is_null($this->_context)) {
            if (CLI_SCRIPT or NO_MOODLE_COOKIES) {
                ...
                debugging('Coding problem: The page\'s context is not set.  You may have forgotten to call require_login() or $PAGE->set_context().  The page may not display correctly as a result');
            }
